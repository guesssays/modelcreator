...
async function handleStartGeneration(chatId) {
  ...
  await sendMessage(
    ...
    [
      ...
      "",
      "✅ Что подойдёт:",
      "• худи, куртка, штаны и т.п.",
      "• хорошее ровное освещение",
      "• чистый однотонный фон",
      "• без посторонних предметов и надписей вокруг (надписи только на одежде)",
      "",
      "🚫 Что не подойдёт:",
      "• вещь на человеке — сфотографируйте её отдельно:",
      "  на вешалке, манекене или аккуратно разложенной"
    ].join("\n"),
    {}
  );
}
